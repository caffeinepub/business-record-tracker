...
export interface _SERVICE {
  ...
  'getDailySummary' : ActorMethod<[string], [bigint, bigint, bigint]>,
  'getExpenseCategories' : ActorMethod<[], Array<[string, bigint]>>,
  'getMonthlySummary' : ActorMethod<[string, string], [bigint, bigint, bigint]>,
