...
export class Backend implements backendInterface {
    ...
    async addTransaction(arg0: string, arg1: string, arg2: string, arg3: bigint, arg4: string, arg5: string): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getDailySummary(arg0: string): Promise<[bigint, bigint, bigint]> {
        if (this.processError) {
            try {
    ...
    async getExpenseCategories(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
    ...
    async getMonthlySummary(arg0: string, arg1: string): Promise<[bigint, bigint, bigint]> {
        if (this.processError) {
            try {
